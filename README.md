- This repo is C++ (Mainly) Based modification for the source engine using Valves popular source SDK as a template. Runs out of a depriciated code editor with specific modifications (VS 2013).
