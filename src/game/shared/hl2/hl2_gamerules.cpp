...
ConVar	sk_plr_dmg_pdw			("sk_plr_dmg_pdw", "0", FCVAR_REPLICATED);
ConVar	sk_npc_dmg_pdw			("sk_npc_dmg_pdw", "0", FCVAR_REPLICATED);
ConVar	sk_max_pdw				("sk_max_pdw", "0", FCVAR_REPLICATED);
...
CAmmoDef *GetAmmoDef()
{
	...
	if ( !bInitted )
	{
		...
		def.AddAmmoType("PDW",				DMG_BULLET,					TRACER_LINE_AND_WHIZ,	"sk_plr_dmg_pdw",			"sk_npc_dmg_pdw",			"sk_max_pdw",			BULLET_IMPULSE(200, 1225), 0);
