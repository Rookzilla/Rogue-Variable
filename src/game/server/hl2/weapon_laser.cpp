...
ConVar	laser_use_new_accuracy( "laser_use_new_accuracy", "1" );
...
public:
	...
	{		
		...
		if ( laser_use_new_accuracy.GetBool() )
		{
...
// Output :
//-----------------------------------------------------------------------------
void CWeaponLaser::Operator_HandleAnimEvent( animevent_t *pEvent, CBaseCombatCharacter *pOperator )
{
	switch( pEvent->event )
	{
...
// Purpose:
//-----------------------------------------------------------------------------
void CWeaponLaser::DryFire( void )
{
	WeaponSound( EMPTY );
...
// Purpose:
//-----------------------------------------------------------------------------
void CWeaponLaser::PrimaryAttack( trace_t &tr, int nDamageType, CBaseCombatCharacter *pOperator )
{
	...
	if( pOwner )
	{
		// Each time the player fires the laser, reset the view punch. This prevents
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponLaser::UpdatePenaltyTime( void )
{
	CBasePlayer *pOwner = ToBasePlayer( GetOwner() );
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponLaser::ItemPreFrame( void )
{
	UpdatePenaltyTime();
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponLaser::ItemBusyFrame( void )
{
	UpdatePenaltyTime();
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponLaser::AddViewKick( void )
{
...
//-----------------------------------------------------------------------------
void CWeaponLaser::DrawBeam(const Vector &startPos, const Vector &endPos, float width)
{
...
//          nDamageType - ???
//-----------------------------------------------------------------------------
void CWeaponLaser::DoImpactEffect(trace_t &tr, int nDamageType)
{
	//Draw our beam
